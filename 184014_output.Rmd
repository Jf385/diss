...
## This can then be repeated for different years comparisons, introducing 2019...
...
df_m_j <- data.frame(x = posterior_difference_j_d$posterior_samples)
```
...
```{r}
jesp_2014 <- list_of_files %>% filter(journal == "journal_exp_soc_psy", year == "2014", has_words == "TRUE", new_col == "Not reported")
jesp_2014
